...
**참고:** 이러한 명령을 시도하기 전에 아두이노 IDE의 Serial Monitor에서 baudrate를 57600으로 설정하고 line terminator를 Serial Monitor 창 하단 오른쪽에 있는 두 드롭다운 메뉴를 사용하여 "Carriage return" 또는 "Both NL & CR"로 설정하세요.
